...
# Xenopus tropicalis has more barcode information in the other columns, so best to keep a maximum of info.
cut -d"," -f1-3 Xt_nc_barcodes.csv.tmp > Xt_nc_barcodes.csv